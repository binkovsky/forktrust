...
func Execute() error {
	...
	rootCmd.AddCommand(newCmd, listCmd, finishCmd, rmCmd, configCmd, trustCmd, aiCmd, agentDocsCmd, execCmd, statusCmd, cdCmd, shellCmd, doctorCmd, scopeCmd, prCmd, prStatusCmd, mcpCmd)
